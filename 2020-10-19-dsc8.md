...
If you really want to read this just as webpage text without the code, you have that option. But if there ever were a time to confront any uneasiness you feel about looking at code as you read a narrative description of DH work, you're not going to find a more friendly, fun, and colloquial place to start than DSC #8: *Text-Comparison-Algorithm-Crazy Quinn*. You can find it in its best form [in the GitHub repo for this book](https://github.com/datasittersclub/dsc8/blob/main/dsc8_text_comparison_algorithm_crazy_quinn.ipynb), along with data and visualizations used here.
